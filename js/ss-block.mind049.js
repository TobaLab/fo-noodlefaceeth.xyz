!(function (t) {
  ...
  !(function (t) {
    ...
    o.d("SmartSliderBlock", ["SmartSliderAbstract"], function () {
      function t(t, i) {
        (this.type = "block"),
          (this.responsiveClass = o.SmartSliderResponsiveBlock),
          o.SmartSliderAbstract.prototype.constructor.call(this, t, i);
      }
      return (
        (t.prototype = Object.create(o.SmartSliderAbstract.prototype)),
        (t.prototype.constructor = t),
        (t.prototype.initResponsiveMode = function () {
          (this.responsive = new o.SmartSliderResponsiveBlock(
            this,
            this.parameters.responsive
          )),
            this.responsive.start(),
            o.SmartSliderAbstract.prototype.initResponsiveMode.call(this);
        }),
          ...
          (this.mainAnimation = !1),
            this.isAdmin ||
              ...
              (this.postBackgroundAnimation =
                new o.SmartSliderPostBackgroundAnimation(this, !1));
        }),
    ...
    o.d("SmartSliderResponsiveBlock", ["SmartSliderResponsive"], function () {
      function t() {
        o.SmartSliderResponsive.prototype.constructor.apply(this, arguments),
          (this.o = this.sliderElement.classList.contains(
            "n2-ss-full-page--constrain-ratio"
          ));
      }
      return (
        (t.prototype = Object.create(o.SmartSliderResponsive.prototype)),
        (t.prototype.constructor = t),
        (t.prototype.init = function () {
          o.SmartSliderResponsive.prototype.init.call(this),
            (this._cacheEl = {
              slider:
        ...
        (t.prototype.calculateResponsiveValues = function () {
          ...
          if (
            ...
            o.SmartSliderResponsive.prototype.calculateResponsiveValues.call(
              this
            ),
            this.o)
          ) {
            var h =
              ...
              r =
                (this.resizeContext.sliderHeight -
                  ...
                  -2 +
                "px";
            o.MW.i(this._cacheEl.slider)["--ss-clip-path"] =
              "inset(" + r + " " + h + " " + r + " " + h + ")";
          }
        }),
        t
    ...
    o.d("ss-block", ["SmartSliderBlock", "SmartSliderResponsiveBlock"]);
})(window);
