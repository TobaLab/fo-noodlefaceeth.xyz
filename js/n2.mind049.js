!(function (t) {
  ...
  var n,
    ...
    f =
      ...
      function (t, i = null, n = null, r = null) {
        const o = s.createElement(t);
        return (
          i && ("string" == typeof i ? m(o, i) : w(o, i)),
          n && v(o, n),
          r && g(o, r),
          o
        );
    ...
    function () {
      ...
      function u() {
        ...
        !i.n2Slow && n.length && (i.n2Slow = !0),
          n.unshift.apply(n, s),
          (s = n).length ? _(u, { timeout: 2e3 }) : (o = !1);
      }
      function c(t) {
      ...
      for (var m = 0; m < this._N2._d.length; m++)
        h.d.apply(this, this._N2._d[m]);
      for (var w = 0; w < this._N2._r.length; w++)
        h.r.apply(this, this._N2._r[w]);
    }.call(i),
  ...
  var O,
    k = "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1;
  (i.n2const = {
    ...
    (i.n2const.isTablet =
      !i.n2const.isPhone &&
      (/Android|iPad|tablet|Silk/i.test(navigator.userAgent) || k)),
    (i.n2const.rtl =
    ...
    h.d("UniversalPointer", function () {
      ...
      (s.prototype.addTimeout = function (t) {
        ...
        (l.prototype.leave = function () {
          ...
          (this.isActive = !1),
            (i = this.el),
            y(i, new Event("universalleave", { bubbles: !1, cancelable: !1 }));
        }),
      ...
      return function (u, h) {
        ...
        function F(e, t) {
          if (
            ...
            if (
              ...
              (o = !0),
                0 !== p &&
                  l.push(M(s, O[p][1], A, { passive: !1, capture: !0 })),
                l.push(M(s, O[p][2], R, { passive: !1, capture: !0 })),
                l.push(M(s, O[p][3], R, { passive: !1, capture: !0 })),
                l.push(M(n, O[p][4], I, { passive: !1, capture: !0 })),
                (m = {
        ...
        function A(t) {
          (t.isPrimary === r || t.isPrimary) &&
            (("x" === f.axis && ((!f.preventScroll && v) || k[p](t))) ||
              P(t.target) ||
              (C(t),
              (Math.abs(w.x) > 10 || Math.abs(w.y) > 10) && (x = !1),
              (v === r &&
                2 !== p &&
                (v = Math.abs(w.x) < Math.abs(w.y) && !f.preventScroll)) ||
                (f.move(t, m, w, d) && f.preventDefault && S(t))));
        }
        function I(t) {
        ...
        return (
          ...
          y.push(M(u, "dragstart", S)),
          f.mouse &&
            0 === _ &&
            y.push(
              M(u, O[2][0], function (e) {
                F(e, 2);
              })
            ),
          y.push(
            M(u, "click", function (t) {
              x ? f.click(t) : S(t);
            })
          ),
          {
    ...
    h.d("GSAP", function () {
      ...
      !(function (e) {
        ...
        var Bi,
          ...
          Yi =
            (((Bi = ji.prototype).delay = function (t) {
              return t || 0 === t
                ? (this.parent &&
            ...
            (Bi.time = function (t, e) {
              return arguments.length
                ? this.totalTime(
                    Math.min(this.totalDuration(), t + L(this)) % this._dur ||
                      (t ? this._dur : 0),
                    e
                  )
                : this._time;
        ...
        var Ni = (function (i) {
          ...
          return (
            ...
            (a.updateRoot = function (t) {
              if (
                (wt._ts && (P(wt, B(t, wt)), (Ot = Fi.frame)), Fi.frame >= di)
              ) {
                di += Qt.autoSleep || 120;
                var e = wt._first;
                if (
        ...
        var Ui,
          ...
          Zi = function t(e, i) {
            ...
            if (
              ...
              (e._yEase = C ? Ti(zi(!0 === C ? w : C, Ut.ease)) : 0),
              C &&
                e._yoyo &&
                !e._repeat &&
            ...
            : ("px" === h || d || (u = Bn(t, e, i, "px")),
              ...
              (!p && "%" !== h) || (!Mr[e] && !~e.indexOf("adius"))
                ? ((f[c ? "width" : "height"] = 100 + (d ? h : n)),
                  ...
                  (o = s._gsap) && p && o.width && c && o.time === Fi.time
                    ? x((u / o.width) * 100)
                    : ((!p && "%" !== h) || (f.position = An(t, "position")),
                      ...
                      s.removeChild(tr),
                      (f.position = "absolute"),
                      c && p && (((o = y(s)).time = Fi.time), (o.width = s[v])),
          ...
          if (e.tween && e.tween._time === e.tween._dur) {
            ...
            if ("all" === a || !0 === a) (o.cssText = ""), (n = 1);
              ...
              for (r = (a = a.split(",")).length; -1 < --r; )
                (i = a[r]),
                  Mr[i] && ((n = 1), (i = "transformOrigin" === i ? Ar : Fr)),
                  Dn(s, i);
            n &&
              (Dn(s, Fr),
              u &&
        ...
        function Zn(t, e, i, n, r, s) {
          ...
          i
            ...
            s &&
              (Ln(s, h, "xOrigin", c, x),
              Ln(s, h, "yOrigin", l, _),
              Ln(s, h, "xOffset", v, h.xOffset),
              Ln(s, h, "yOffset", d, h.yOffset)),
        ...
        function Hn(t, e, i) {
          ...
          Mr))
            (s = f[r]) !== (o = n[r]) &&
              ...
              ((a = G(s) !== (h = G(o)) ? Bn(i, r, s, h) : parseFloat(s)),
              (u = parseFloat(o)),
            ...
            return (
              ...
              g !== Dr &&
                ...
                i.svg &&
                  ...
                  (i.forceCSS =
                    t.setAttribute("transform", "") || !Qn(An(t, Fr))),
                          ...
                          (o = jn(o)),
                            w.svg
                              ...
                              : ((v = parseFloat(o.split(" ")[2]) || 0) !==
                                  w.zOrigin &&
                                  Ln(this, w, "zOrigin", w.zOrigin, v),
                                Ln(this, x, c, Xr(s), Xr(o)));
                          continue;
                        }
                        if ("svgOrigin" === c) {
                          Zn(t, o, 1, y, 0, this);
        ...
        (gn.utils.checkPrefix = Rr),
          ...
          (Cr[Vr[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + Zr),
          M(
